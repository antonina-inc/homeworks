...
if (confirm('Почати тестування?')) {
	class Remember {
		static myRemember: Remember
		msg
		interval
		intervalRemember!: ReturnType<typeof setInterval>;
		constructor(msg: string | null, interval: number) {
			if (Remember.myRemember) return Remember.myRemember
			this.msg = msg
